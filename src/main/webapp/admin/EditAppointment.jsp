...
<div class="col-md-4 offset-md-4">
				<div class="card paint-card">
					<div class="card-body">
						...
						%>
						<form action="../appointmentEdit" method="post">
							<div class="mb-3">
							...
							<div class="mb-3">
								<label class="form-label">Age</label><input type="text" required
									name="age" class="forn-control" value="<%=d.getAge() %>">
							</div>
							<div class="mb-3">
								<label class="form-label">Appointment Date</label><input type="date" required
									name="appointdate" class="forn-control" value="<%=d.getAppoinDate() %>">
							</div>
							<div class="mb-3">
							...
							<label class="form-label">Set Status</label><input
									type="text" required name="status" class="forn-control" value="<%=d.getStatus() %>">
							</div>
